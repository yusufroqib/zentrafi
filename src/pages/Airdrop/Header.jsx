      ...
      <div className="relative p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            >
              Send project tokens to multiple wallets at once. Use this for
              running promotions, rewarding users, or distributing tokens to
              your community. Fast, efficient, and cost-effective.
            </motion.p>
